...
class WaveEdit:
    ...
    def setNICEdit(self, sheet, r):
        ...
        if len(self.driver.find_elements(By.XPATH, self.pop_edit_xpath)) != 0:
            ...
            time.sleep(5)
            vCenter_class = self.driver.find_element(By.XPATH, self.txt_editCU_xpath).get_attribute("class")
            if vCenter_class == "ui-state-default ui-corner-top ng-star-inserted ui-tabview-selected ui-state-active":
                ...
                if len(self.driver.find_elements(By.XPATH, self.pop_addNIC_xpath)) != 0:
                    ...
                    totalNICs = len(self.driver.find_elements(By.XPATH, self.txt_totalNICs_xpath))
    ...
    def setNICBulkEdit(self, sheet, r):
        ...
        if len(self.driver.find_elements(By.XPATH, self.pop_bulkEdit_xpath)) != 0:
            ...
            self.driver.find_element(By.LINK_TEXT, "vCenter Options").click()
            vCenter_class = self.driver.find_element(By.XPATH, self.txt_bulkEditCU_xpath).get_attribute("class")
            if vCenter_class == "ui-state-default ui-corner-top ng-star-inserted ui-tabview-selected ui-state-active":
    ...
    def setOCISync(self, sheet, r):
        ...
        if len(self.driver.find_elements(By.XPATH, self.pop_edit_xpath)) != 0:
            ...
            time.sleep(5)
            oci_class = self.driver.find_element(By.XPATH, self.txt_editCU_xpath).get_attribute("class")
    ...
    def setOCIBulkSync(self, sheet, r):
        waveName = sheet.cell(row=r, column=1).value
        VCNName = sheet.cell(row=r, column=5).value
        SubnetName = sheet.cell(row=r, column=6).value
        AVDomain = sheet.cell(row=r, column=7).value
        ...
        if len(self.driver.find_elements(By.XPATH, self.pop_bulkEdit_xpath)) != 0:
            ...
            self.driver.find_element(By.LINK_TEXT, "OCI Options").click()
            time.sleep(5)
            oci_class = self.driver.find_element(By.XPATH, self.txt_bulkEditCU_xpath).get_attribute("class")
            if oci_class == "ui-state-default ui-corner-top ng-star-inserted ui-tabview-selected ui-state-active":
    ...
    def setSyncOptions(self, path, start, end):
        ...
        for r in range(st, ed+1):
            ...
            if len(self.driver.find_elements(By.XPATH, self.pop_edit_xpath)) != 0:
                ...
                self.driver.find_element(By.XPATH, self.btn_syncOptions_xpath).click()
                time.sleep(5)
                syncOpt_class = self.driver.find_element(By.XPATH, self.txt_editSyncOption_xpath).get_attribute("class")
